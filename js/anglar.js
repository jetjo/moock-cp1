        ...
        if (obj)
        {
            if (isFunction(obj))
            {
                for (key in obj)
                {
                    ...
                    if (key != 'prototype' && key != 'length' && key != 'name' && (!obj.hasOwnProperty || obj.hasOwnProperty(
                        key)))
                    {
    ...
    */
            ...
            if (!getterIfNoArguments || param != null)
            {
                while (list.length)
                {
                    ...
                    for (setIndex = 0, setLength = set.length; setIndex < setLength; setIndex++)
                    {
                        ...
                        for (childIndex = 0, childLength = (children = element.children()).length; childIndex <
    ...
    forEach({
        ...
        on: function onFn(element, type, fn, unsupported)
        {
            ...
            if (!handle) jqLiteExpandoStore(element, 'handle', handle = createEventHandler(element,
                events));
                ...
                $controller, $rootScope, $document, $sce, $animate, $$sanitizeUri)
            {
                    ...
                    previousCompileContext)
                {
                    ...
                    for (var i = 0; i < nodeList.length; i++)
                    {
                        ...
                        directives = collectDirectives(nodeList[i], [], attrs, i === 0 ? maxPriority :
                            undefined,
                            ignoreDirective);
                        ...
                        case 1:
                                ...
                                j = 0, jj = nAttrs && nAttrs.length; j < jj; j++)
                            {
                                ...
                                if (!msie || msie >= 8 || attr.specified)
                                {
                                    ...
                                    addDirective(directives, nName, 'A', maxPriority, ignoreDirective,
                                        attrStartName,
                                        attrEndName);
                                }
                            }
                    ...
                    previousCompileContext)
                {
                    ...
                    for (var i = 0, ii = directives.length; i < ii; i++)
                    {
                        ...
                        if (directiveValue = directive.transclude)
                        {
                            ...
                            if (!directive.$$tlb)
                            {
                                assertNoDuplicate('transclusion', nonTlbTranscludeDirective, directive,
                                    $compileNode);
                                        ...
                                        isolateScope.$watch(function parentValueWatch()
                                        {
                                            ...
                                            if (!compare(parentValue, isolateScope[scopeName]))
                                            {
                                                ...
                                                } else
                                                {
                                                    ...
                                                    parentSet(scope, parentValue = isolateScope[
                                                        scopeName]);
                                                }
                                            }
...
<file name="protractorTest.js">
  ...
  it('should make JSONP request to invalid URL and invoke the error handler',
    ...
    function $HttpBackendProvider()
    {
        ...
        {
            return createHttpBackend($browser, createXhr, $browser.defer, $window.angular.callbacks,
                $document[0]);
        }];
    }
            ...
            function $interpolate(text, mustHaveExpression, trustedContext)
            {
                ...
                while (index < length)
                {
                        ...
                        ((endIndex = text.indexOf(endSymbol, startIndex + startSymbolLength)) != -1))
                    {
                        ...
                        parts.push(fn = $parse(exp = text.substring(startIndex + startSymbolLength,
                            endIndex)));
                        fn.exp = exp;
            ...
            function ($rootScope, $browser, $sniffer, $rootElement)
            {
                ...
                $rootScope.$watch(function $locationWatch()
                {
                    ...
                    if (!changeCounter || oldUrl != $location.absUrl())
                    {
                        ...
                        $rootScope.$evalAsync(function ()
                        {
                            if ($rootScope.$broadcast('$locationChangeStart', $location.absUrl(),
                                oldUrl).defaultPrevented)
                            {
                                $location.$$parse(oldUrl);
                            } else
                ...
                promise: {
                    then: function (callback, errback, progressback)
                    {
                        ...
                        var wrappedCallback = function (value)
                        {
                            try
                            {
                                result.resolve((isFunction(callback) ? callback : defaultCallback)(
                                    value));
                            } catch (e)
                            {
                                result.reject(e);
                        ...
                        var wrappedErrback = function (reason)
                        {
                            try
                            {
                                result.resolve((isFunction(errback) ? errback : defaultErrback)(
                                    reason));
                            } catch (e)
                            {
                                result.reject(e);
                        ...
                        var wrappedProgressback = function (progress)
                        {
                            try
                            {
                                result.notify((isFunction(progressback) ? progressback :
            ...
            function ($injector, $exceptionHandler, $parse, $browser)
            {
                ...
                Scope.prototype = {
                    ...
                    $new: function (isolate)
                    {
                        ...
                        child.$$listenerCount = {};
                        child.$parent = this;
                        child.$$watchers = child.$$nextSibling = child.$$childHead = child.$$childTail =
                            null;
                        ...
                        function $watchCollectionWatch()
                        {
                            ...
                            } else
                            {
                                ...
                                if (oldLength > newLength)
                                {
                                    ...
                                    for (key in oldValue)
                                    {
                                        if (oldValue.hasOwnProperty(key) && !newValue.hasOwnProperty(
                                            key))
                                        {
                                            oldLength--;
                                            delete oldValue[key];
                                        ...
                                        try
                                        {
                                            ...
                                            if (watch)
                                            {
                                                            ...
                                                            isNaN(value) && isNaN(last))))
                                                {
                                                    ...
                                                    watch.fn(value, ((last === initWatchVal) ?
                                                        value : last), current);
                                                    if (ttl < 5)
                                                    {
                                                        logIdx = 4 - ttl;
                ...
                compile: function (element, attr)
                {
                    ...
                    return function (scope, $element, $attr, ctrl, $transclude)
                    {
                        ...
                        scope.$watch($sce.parseAsResourceUrl(srcExp), function ngIncludeWatchAction(src)
                        {
                            ...
                            {
                                if (isDefined(autoScrollExp) && (!autoScrollExp || scope.$eval(
                                    autoScrollExp)))
                                {
                                    $anchorScroll();
                                }
            ...
            link: function ($scope, $element, $attr, ctrl, $transclude)
            {
                ...
                $scope.$watchCollection(rhs, function ngRepeatAction(collection)
                {
                    ...
                    for (index = 0, length = collectionKeys.length; index < length; index++)
                    {
                        ...
                        if (nextBlockOrder[index - 1]) previousNode = getBlockEnd(
                        ...
                        if (block.scope)
                        {
                            ...
                            if (getBlockStart(block) != nextNode)
                            {
                                ...
                                $animate.move(getBlockElements(block.clone), null, jqLite(
                                    previousNode));
                            }
                ...
                scope.$watch(watchExpr, function ngSwitchWatchAction(value)
                {
                        ...
                        ngSwitchController.cases['?']))
                    {
                        ...
                        forEach(selectedTranscludes, function (selectedTransclude)
                        {
                            ...
                            selectedTransclude.transclude(selectedScope, function (
                                caseElement)
                            {
                                var anchor = selectedTransclude.element;

                                selectedElements.push(caseElement);
                                $animate.enter(caseElement, anchor.parent(),
                                    anchor);
                            });
                        });
                    }
                ...
                function setupAsOptions(scope, selectElement, ctrl)
                {
                    ...
                    selectElement.on('change', function ()
                    {
                        scope.$apply(function ()
                        {
                            ...
                            {
                                value = [];
                                for (groupIndex = 0, groupLength = optionGroupsCache.length; groupIndex <
                                    groupLength; groupIndex++)
                                {
                                    ...
                                    for (index = 1, length = optionGroup.length; index <
                                        length; index++)
                                    {
                                        if ((optionElement = optionGroup[index].element)[
                                            0].selected)
                                        {
                    ...
                    function render()
                    {
                        ...
                        for (index = 0; length = keys.length, index < length; index++)
                        {
                            ...
                            {
                                selected = isDefined(
                                    selectedSet.remove(trackFn ? trackFn(scope, locals) : valueFn(
                                        scope, locals))
                                );
                            } else
                            {
                        ...
                        for (groupIndex = 0, groupLength = optionGroupNames.length; groupIndex <
                            groupLength; groupIndex++)
                        {
